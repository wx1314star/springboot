...
public enum ErrorCode {
    ID_IS_NULL(400, "ID_IS_NULL", "ID为空!"), ENT_CODE_IS_NULL(400, "ENT_CODE_IS_NULL", "企业编码为空!"),
    ADMIN_ACCOUNT_IS_NULL(400, "ADMIN_ACCOUNT_IS_NULL", " 企业管理员账号为空!"), UUID_IS_NULL(400, "UUID_IS_NULL", " UUID为空!"),
    MODIFY_FAIL(400, "MODIFY_FAIL", "修改失败!"),
    ...
    STATE_FORMAT_ERROR(400, "STATE_FORMAT_ERROR", "状态参数格式有误!"), STATE_IS_NULL(400, "STATE_IS_NULL", "状态为空!"),
    TEST_CATALOG_ADD_FAIL(400, "TEST_CATALOG_ADD_FAIL", "题库信息添加失败!"),
    TEST_CATALOG_DELETE_FAIL(400, "TEST_CATALOG_DELETE_FAIL", "题库信息删除失败！"),
    TEST_CATALOG_UPDATE_FAIL(400, "TEST_CATALOG_UPDATE_FAIL", "题库信息修改失败!"), OPT_IS_NULL(400, "OPT_IS_NULL", "操作动作为空!");
